  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#070b14] px-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-1/3 w-[500px] h-[500px] bg-purple-600/5 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/3 left-1/3 w-[400px] h-[400px] bg-blue-600/5 rounded-full blur-[150px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="card-base p-8" style={{ animation: 'scale-in 0.5s ease-out' }}>
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-purple-600/20 border border-purple-500/30 flex items-center justify-center text-2xl mx-auto mb-4">
              ✨
            </div>
            <h1 className="text-2xl font-bold">Join WorldQuest</h1>
