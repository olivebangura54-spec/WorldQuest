      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              The realm remembers you, quester.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              ...
              <Link
                ...
                className="text-xs font-medium transition-all duration-200 hover:drop-shadow-[0_0_8px_rgba(34,211,238,0.4)]"
                style={{ color: "#67e8f9" }}
            ...
            {/* Submit button */}
            <div style={{ animation: "stagger-fade-in 0.5s ease-out 0.3s both" }}>
              <button
                type="submit"
                disabled={isLoading}
          ...
          <div
            ...
            style={{ animation: "stagger-fade-in 0.5s ease-out 0.35s both" }}
          >
          ...
          {/* ─── Google button ─── */}
          <div style={{ animation: "stagger-fade-in 0.5s ease-out 0.4s both" }}>
            <button
              type="button"
          ...
          <p
            ...
            style={{ animation: "stagger-fade-in 0.5s ease-out 0.45s both" }}
          >
